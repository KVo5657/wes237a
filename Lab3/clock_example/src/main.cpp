...
int main(int argc, const char * argv[])
{
    ...
    unsigned int cpu_count_before, cpu_count_after, cpu_count;
	...
	cout << "CPU Cycle Count: " << cpu_count << "\n" << "Timer: " << (double)cpu_timer/1000000000.0 << endl;
